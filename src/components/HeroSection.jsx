...
const HeroSection = () => {
    return (
        <section className="h-screen bg-linear-to-b from-violet-900 to-black flex xl:flex-row flex-col-reverse items-center justify-between lg:px-24 px-10 relative overflow-hidden">

            {/* left section  */}
            <div className="z-40 xl:mb-0 mb-[3%] ">
                <motion.h1
            ...
            {/* Right Section  */}
            <Spline 
            className='absolute xl:right-[-30%] right-0 top-[-30%] lg:top-0 ' 
